...
public abstract class AbstractCartCalculator 
{
	...
	// Die nachfolgende Testmethode ist fuer die Loesung der
	// Aufgabe nicht zwingend erforderlich. Sie kann verwendet
	...
	// ACHTUNG: Dieser Testfall ist nur ein Ausschnitt der
	// Testsuite, die nach der Abgabe ausgefuehrt wird. Ein
	// korrektes Ergebnis in diesem Testfall garantiert nicht,
	...
	{		
		...
		// Schreiben von nur einem Tripel (kompliziertere
		// Testfaelle gibt es dann auf dem Server)
		try {
